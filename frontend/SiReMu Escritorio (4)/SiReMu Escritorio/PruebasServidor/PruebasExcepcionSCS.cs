...
namespace PruebasServidor {
    /// <summary>
    /// Estas son las pruebas para cuando no se encuentra disponible una conexion con el servidor
    /// Requisitos: El servidor de canciones no debe estar en linea
    /// </summary>
    [TestClass]
