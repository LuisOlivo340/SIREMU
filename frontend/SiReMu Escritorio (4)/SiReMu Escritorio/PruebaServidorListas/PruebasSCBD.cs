...
namespace PruebaServidorListas {
    /// <summary>
    /// Estas son las pruebas para el servidor de listas cuando no se encuentra activa la base de datos
    /// Requisitos: No debe estar la base de datos activa o el servidor debe estar erroneo en sus credenciales de acceso
    /// </summary>
    [TestClass]
    public class PruebasSCBD {
